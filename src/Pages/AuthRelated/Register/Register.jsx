        ...
        <div>
            ...
            <form onSubmit={handleSubmit(handleRegister)}>
                <fieldset className="fieldset">
                    ...
                    {/* Name */}
                    <label className="label font-medium text-gray-800  text-[14px]">Name</label>
                    ...
                    {/* Photo image field */}
                    <label className="label font-medium text-gray-800 text-[14px]">Upload an image</label>
                    ...
                    {/* email */}
                    <label className="label font-medium text-gray-800 text-[14px]">Email</label>
                    ...
                    {/* password */}
                    <label className="label font-medium text-gray-800 text-[14px]">Password</label>
