        ...
        <footer className="bg-gray-900 text-gray-300 py-10 mt-10">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid gap-10 md:gap-6 sm:grid-cols-2 md:grid-cols-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <h2 className="text-xl font-bold text-white"> Contestify </h2>

                        </div>

                        <p className="text-sm font-medium">
                            Contestify brings creativity to life through a modern contest platform that enables seamless creation, participation, and management of contests—powered by secure authentication, integrated payments, and intuitive dashboards.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li className="flex  gap-2 items-center"><CiMail className="text-[#fff022] text-xl" /> support@contestify.com</li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link to="/all-contests" className="hover:text-white duration-200">All Contests</Link></li>
                    ...
                    <div>
                        ...
                        {/* Social Icons */}
                        <h3 className="text-lg font-semibold text-white my-2">Social Links</h3>
                ...
                <div className="border-t border-gray-700 mt-10 pt-6 text-center text-sm flex justify-center items-center gap-1">
                    ...
                    <FaRegCopyright />
                    <span>Contestify — All Rights Reserved.</span>
                </div>
